                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="<?= base_url()?>"><img width="80" src="<?= base_url('assets/images/logo.png') ?>" alt="logo images"></a>
                                </div>
                            </div>
                                            ...
                                            <ul class="dropdown mega_dropdown">
                                                ...
                                                <li><a class="mega__title" href="product-grid.html">Bandung</a>
                                                    <ul class="mega__item">
                                                        ...
                                                        <li><a href="wishlist.html">Ciater</a></li>
                                                        <li><a href="cart.html">Cimahi</a></li>
                                                        <li><a href="checkout.html">Kabupaten Bandung</a></li>
                                                    </ul>
                                                </li>
                                                <!-- End Single Mega MEnu -->
                                                <!-- Start Single Mega MEnu -->
            ...
            <div class="shopping__cart">
                <div class="shopping__cart__inner">
                    ...
                    <ul class="shopping__btn">
                        ...
                        <li class="shp__checkout"><a href="<?= base_url("Welcome/login") ?>">Login</a></li>
                    </ul>
                </div>
            </div>
            <!-- End Cart Panel -->
